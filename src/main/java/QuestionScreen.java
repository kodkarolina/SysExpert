...
public class QuestionScreen {
    ...
    private void $$$setupUI$$$() {
        ...
        questionArea.setBackground(new Color(-789517));
        questionArea.setEditable(false);
        Font questionAreaFont = this.$$$getFont$$$(null, -1, 16, questionArea.getFont());
        if (questionAreaFont != null) questionArea.setFont(questionAreaFont);
